...
void display(void)
{
	...
	glPushMatrix();//inserisce la matrice di trasformazione corrente nella pila di matrici
		glutSolidSphere(0.3, 15, 15);//disegna il sole
		glPushMatrix();
			...
			glPushMatrix();
				...
				glutSolidSphere(0.03, 10, 8);//disegna il primo satellite
			glPopMatrix();
	
			glColor3f (0.0, 0.0, 1.0);
			glRotatef ((GLfloat) giro_intorno_a_se_stesso_1, 0.0, 1.0, 0.0);
			glutSolidSphere(0.08, 10, 8);//disegna il primo pianeta
		glPopMatrix();	
		...
		glPushMatrix();
			...
			glPushMatrix();
				...
				glutSolidSphere(0.03, 10, 8);//disegna il secondo satellite
			glPopMatrix();
	
			glColor3f (1.0, 0.0, 1.0);
			glRotatef ((GLfloat) giro_intorno_a_se_stesso_2, 0.0, 1.0, 0.0);
			glutSolidSphere(0.08, 10, 8);//disegna il secondo pianeta
		glPopMatrix();	
